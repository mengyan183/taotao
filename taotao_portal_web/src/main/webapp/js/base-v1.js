 ...
 */
function login() {
    return location.href = "http://localhost:9906/user/showLogin";
}
function regist() {
    return location.href = "http://localhost:9906/user/showRegister";
}
...
function search(a) {
    var b = "http://localhost:9905/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
